curl -XPUT http://localhost:9200/_template/logstash_pa_traffic -d '
{
    "template" : "logstash-pa-traffic-*",
    "settings" : {
        "number_of_shards" : 1,
            ...
            "properties" : {
               "@fields" : {
                    ...
                    "properties" : {
                        ...
                        "BytesReceived" : { "type": "long", "index": "not_analyzed" },
                        "BytesSent" : { "type": "long", "index": "not_analyzed" },
                        ...
                        "ElapsedTimeInSec" : { "type": "long", "index": "not_analyzed" },
                        ...
                        "Padding" : { "type": "integer", "index": "not_analyzed" },
                        "PaloAltoDomain" : { "type": "integer", "index": "not_analyzed" },
                        ...
                        "StartTime" : { "type": "string", "index": "not_analyzed" },
                        ...
                        "cpadding" : { "type": "integer", "index": "not_analyzed" },
                        "pkts_received" : { "type": "long", "index": "not_analyzed" },
                        "pkts_sent" : { "type": "long", "index": "not_analyzed" },

module KibanaConfig
  ...
  # FIXME: Remember, this is connecting to the stunnel port
  ...
  Default_fields = ['@fields.TimeLogged', '@fields.Type', '@fields.Threat-ContentType', '@fields.SourceAddress', '@fields.DestinationAddress', '@fields.DestinationPort', '@fields.Application', '@fields.Bytes', '@fields.Action']
  ...
  Smart_index_pattern = ['logstash-pa-threat-%Y.%m.%d', 'logstash-pa-traffic-%Y.%m.%d']
